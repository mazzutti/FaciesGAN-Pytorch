...
multi-scale binary mask pyramids. Masks are used to indicate which
...
class MaskInterpolator(WellInterpolator):
    ...
    Creates multi-scale binary mask pyramids by downsampling using a voting
    ...
    def interpolate_array(
        ...
        """Create multi-scale binary mask representations from a raw NumPy array."""
