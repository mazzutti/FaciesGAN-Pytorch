...
HPARAM_CATEGORIES = {
    ...
    "⚖️ Loss & Consistency Penalties": [
        ...
        ("vpvs_consistency_penalty", "Vp/Vs consistency weight"),
        ("ipis_correlation_penalty", "Ip-Is correlation weight"),
    ],
    "⚡ Optimization & WGAN-GP / SN": [
        ...
        ("r1_loss_penalty", "R1 regularization weight"),
        ("scale0_r1_loss_penalty", "Scale-0 R1 weight"),
